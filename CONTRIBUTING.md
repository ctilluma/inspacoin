...
posted to #inspacoin-dev on irc.freenode.net).
...
The "InSPa Maintainer Team" is defined in this document as the following users:
- fluffypony
- inspacoinmooo
- hyc
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to InSPa code or InSPa's dependency code or InSPa's potential/future dependency code or research which successfully implements InSPa.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the InSPa Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the InSPa Maintainer Team.
